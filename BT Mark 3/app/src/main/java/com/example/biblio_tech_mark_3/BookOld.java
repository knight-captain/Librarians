...
public class BookOld { //title, author, List genres, List Subjects, int ISBN, longString Description
...
//    entries__physical_format	entries__edition_name	entries__languages__key	entries__publishers__-	entries__publish_date;
    ...
    public BookOld(int id, String title, Author author, List<String> genres, List<String> subjects, long ISBN, String notes) {
        this.id = id;
        this.title = title;
        this.author = author;
        this.genres = genres;
